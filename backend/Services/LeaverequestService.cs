...
namespace backend.Services
{
  public class LeaverequestService
  {
    ...
    {
      var leaverequestGetStart = await _leaverequestRepository.GetLeaverequestByStartDateAsync(leaverequest.StartDate, leaverequest.EmployeeId);
      var leaverequestGetEnd = await _leaverequestRepository.GetLeaverequestByStartDateAsync(leaverequest.EndDate, leaverequest.EmployeeId);
