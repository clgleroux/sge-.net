...
namespace backend.Repositories
{
  public class AttendanceRepository
  {
    ...
    public async Task<Attendance> GetAttendanceByStartDateAsync(DateOnly startDate, int employeeId)
    {
      return await _manageEmployeeDbContext.Attendances.FirstOrDefaultAsync(
    ...
    public async Task<Attendance> GetAttendanceByEndDateAsync(DateOnly endDate, int employeeId)
    {
      return await _manageEmployeeDbContext.Attendances.FirstOrDefaultAsync(
